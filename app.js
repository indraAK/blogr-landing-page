...
dropdowns.forEach(dropdown => dropdown.addEventListener('click', (e) => e.preventDefault()));

mobileDropdownsToggle.forEach(dropdown => dropdown.addEventListener('click', toggleOpen));
